...
"
TS3 Info;<br/>
-Teamspeak 3 ts3.downundermod.com<br/>
<br/>
Official website;<br/>
www.Down-Under.enjin.com<br/>
Ported to DU_SAHRANI by JanTemplar and further Developed by the Down Under Community<br/>
...
Changed: Hideout Re-Scripted<br/>
Removed: Radio Jammers from Item Shops<br/>
Added: Weapon Factory<br/>
Moved: Most Items on the map.<br/>
Added: More DrugFarming Land<br/>
Added: New Sound Effects<br/>
Added: Radio to Cars<br/>
Changed: SpeedUpgrades now at 2 for boats<br/>
<br/>

<br/>
Version 1.12<br>
Added: Terror Boat Shop<br/>
Added: Evos and BMWs<br/>
Added: Intro Music<br/>
Added: Compliance Rules<br/>
Added: Headbug Fixs more problems<br/>
Added: Load Screen<br/>
Changed: Car Prices<br/>
<br/>

Version 1.11<br>
Changed: Moved Oil Processing point<br/>
Changed: Various resource buy/sell prices<br/>
Changed:-Cops now have US weapons in SOBR box<br/>
Fixed:-Whippy's shop.<br/>
Added:-Buildings to the construction factory.<br/>
Added:-New Gat shop to NZ.<br/>
Added:-New guns uzi, gold and siler revolver and the enfiled rifle at NZ Gat shop.<br/>
Added:-3 new servo's u can rob them.<br/>
...
Fixed:-Some items allow over-allocation on acquisition<br/>
Changed:-Some resource pricing<br/>
Changed:-Cops can only pick up legal items. (Take evidence for illegal items)<br/>
Fixed:-Cop Siren Looping<br/>.
Fixed:-Mi17 spawn issue<br/>
Removed:-Factory export options<br/>
Version 1.00<br/>
