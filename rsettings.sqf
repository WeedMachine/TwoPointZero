...
switch (_this select 0) do
{
	...
	{
		/*
			RadioSrc 1: ArmA2 Music
			RadioSrc 2: User Music
			RadioSrc 3: All Music
			RadioSrc 4: Custom Playlist
		*/
		...
		switch (CLAY_RadioSrc) do
		{
			...
			case 3:
			{
				...
				Else
				{
					CLAY_RadioPlayList = CLAY_RadioGameMusic + CLAY_RadioAddMusic;
				};

				If (CLAY_RadioPlaying) Then
				{
					CLAY_RadioTrack = CLAY_RadioTrack + 33;
				}
				Else
				{
					["play"] execVM "rcontrols.sqf";
